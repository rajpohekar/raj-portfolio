...
//     github: "https://github.com/rajpohekar21",
//     color: "#00C896",
//   },
//   {
//     title: "TicketWise",
...
//   },
//   {
//     title: "UAV 5G Optimizer",
//     icon: "📡",
//     subtitle: "Final Year Research Project",
//     stack: ["Python", "ML", "Optimization Algorithms", "Wireless Comm."],
//     desc: "ML-based trajectory optimization for UAV-enabled 5G networks — maximizing coverage, minimizing latency, improving energy efficiency.",
//     highlights: ["ML trajectory optimization", "5G signal coverage", "Energy-efficient path planning"],
//     github: null,
//     color: "#A855F7",
//     featured: true,
//   },
...
//       {display}
//       <span style={{ animation: "blink 1s steps(1) infinite", color: "#00F5FF" }}>|</span>
//     </span>
//   );
// }
...
//       <span style={{ color: "#00F5FF", fontFamily: "'Space Mono', monospace", fontSize: 13, letterSpacing: 2, textTransform: "uppercase" }}>
//         {children}
//       </span>
...
//         @keyframes pulse-glow { 0%,100%{box-shadow:0 0 0 0 #00F5FF33} 50%{box-shadow:0 0 24px 4px #00F5FF33} }
...
//         .project-card::before { content: ''; position: absolute; inset: 0; opacity: 0; transition: opacity 0.3s; border-radius: 16px; }
...
//         .glass { background: rgba(15,22,41,0.8); backdrop-filter: blur(12px); }
...
//         background: navScrolled ? "rgba(11,15,25,0.95)" : "transparent",
//         borderBottom: navScrolled ? "1px solid #1E293B" : "1px solid transparent",
...
//         <div style={{ position: "relative", zIndex: 2, maxWidth: 1100, margin: "0 auto", padding: "0 1.5rem", paddingTop: 80 }}>
//           <div style={{ fontFamily: "'Space Mono', monospace", fontSize: 13, color: "#00F5FF", letterSpacing: 3, textTransform: "uppercase", marginBottom: 24, opacity: 0.8 }}>
//             Available for opportunities
//           </div>
//           <h1 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: "clamp(3rem,8vw,5.5rem)", lineHeight: 1.05, marginBottom: 20, letterSpacing: -1 }}>
//             Hi, I'm{" "}
//             <span style={{ color: "#00F5FF", textShadow: "0 0 40px #00F5FF55" }}>Raj Pohekar</span>
//           </h1>
//           <div style={{ fontSize: "clamp(1.1rem,2.5vw,1.4rem)", color: "#94A3B8", marginBottom: 28, fontWeight: 400, minHeight: 36 }}>
//             <TypingText texts={["Full-Stack Developer", "Backend Engineer", "Competitive Programmer", "Problem Solver"]} />
//           </div>
//           <p style={{ fontSize: 16, color: "#64748B", maxWidth: 560, lineHeight: 1.75, marginBottom: 40 }}>
//             Final-year E&TC Engineering student at PICT, passionate about building scalable backend systems, optimizing complex algorithms, and solving real-world engineering problems.
//           </p>
//           <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
//             <button className="btn-primary" onClick={() => scrollTo("Projects")}>View My Work →</button>
//             <a
//               href="https://drive.google.com/drive/folders/1fWIPXdnRv4djnpFe5kcVCHPFaOIFf0yp"
//               target="_blank"
...
//             {[
//               { label: "LeetCode", value: "270+ solved" },
//               { label: "CodeChef", value: "2⭐ · 1531" },
//               { label: "CGPA", value: "8.65 / 10" },
//             ].map((s) => (
//               <div key={s.label} style={{
//                 background: "#0F1629", border: "1px solid #1E293B", borderRadius: 10,
//                 padding: "10px 20px", display: "flex", flexDirection: "column", gap: 2,
//               }}>
//                 <span style={{ fontSize: 11, color: "#475569", fontFamily: "'Space Mono', monospace", textTransform: "uppercase", letterSpacing: 1 }}>{s.label}</span>
//                 <span style={{ fontSize: 15, color: "#E2E8F0", fontWeight: 600 }}>{s.value}</span>
//               </div>
//             ))}
//           </div>
//         </div>
...
//               I'm a backend-focused developer with strong system design thinking — skilled in designing scalable APIs, secure systems, and optimized workflows. I enjoy breaking complex problems into modular, maintainable architectures.
//             </p>
//             <p style={{ color: "#64748B", lineHeight: 1.8, fontSize: 14 }}>
//               Currently pursuing B.E. in Electronics & Telecommunication Engineering at Pune Institute of Computer Technology (2022–2026), graduating with a CGPA of 8.65.
//             </p>
//             <div style={{ marginTop: 28 }}>
//               <div style={{ fontFamily: "'Space Mono', monospace", fontSize: 12, color: "#475569", letterSpacing: 2, textTransform: "uppercase", marginBottom: 14 }}>Focus Areas</div>
//               <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
//                 {["REST API Design", "JWT Auth & Security", "Razorpay Payments", "DB Indexing", "Event-Driven Arch"].map((t) => (
//                   <Tag key={t}>{t}</Tag>
//                 ))}
//               </div>
//             </div>
...
//             <div style={{ background: "#0F1629", border: "1px solid #1E293B", borderRadius: 16, padding: "1.5rem", marginBottom: 4 }}>
...
//             </div>
//             {[
//               { platform: "LeetCode", stat: "270+ Problems", sub: "Array · DP · Graphs · Trees", color: "#FFA116" },
//               { platform: "CodeChef", stat: "2⭐ Coder", sub: "Max Rating: 1531", color: "#5B4638" },
//             ].map((c) => (
//               <div key={c.platform} className="coding-card">
//                 <div style={{ width: 44, height: 44, borderRadius: 10, background: c.color + "22", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20, flexShrink: 0 }}>
//                   {c.platform === "LeetCode" ? "⚡" : "🍴"}
//                 </div>
//                 <div style={{ flex: 1 }}>
...
//       {/* EXPERIENCE */}
//       <Section id="experience" style={{ borderTop: "1px solid #0F1629" }}>
...
//               </div>
//               <h3 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: 22, marginBottom: 4, color: "#E2E8F0" }}>Research Intern</h3>
//               <div style={{ fontSize: 13, color: "#64748B", marginBottom: 20 }}>Cryptography & Blockchain Research</div>
//               <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 10 }}>
//                 {[
//                   "Studied Elliptic Curve Cryptography (ECC) fundamentals",
//                   "Applied blockchain concepts for secure voting systems",
//                   "Designed lightweight cryptographic validation models",
//                   "Focused on anonymity, security & tamper resistance",
//                 ].map((item) => (
//                   <li key={item} style={{ display: "flex", gap: 10, color: "#94A3B8", fontSize: 14, lineHeight: 1.6 }}>
//                     <span style={{ color: "#00F5FF", marginTop: 2, flexShrink: 0 }}>▸</span>
//                     {item}
//                   </li>
//                 ))}
//               </ul>
//               <button className="btn-primary" style={{ marginTop: 24, fontSize: 12 }}>Read Research Paper ↗</button>
//             </div>
//           </div>
//           {/* Final Year Project */}
...
//               Research-driven project optimizing UAV flight paths using ML to enhance coverage, reduce latency, and improve energy efficiency in 5G networks.
//             </p>
//             <div style={{ display: "flex", flexWrap: "wrap", gap: 6, marginBottom: 16 }}>
//               {["UAV-Assisted Comm.", "ML Optimization", "5G Coverage", "Energy Efficiency"].map((t) => (
//                 <Tag key={t} color="#A855F7">{t}</Tag>
//               ))}
//             </div>
...
//               Bridging ML + Wireless Communication + Optimization
//             </div>
//           </div>
//         </div>
//       </Section>
...
//           {PROJECTS.map((p) => (
//             <div key={p.title} className="project-card" style={{ borderColor: p.featured ? "#A855F733" : "#1E293B" }}>
//               {p.featured && (
//                 <div style={{ position: "absolute", top: 16, right: 16, background: "#A855F722", border: "1px solid #A855F766", borderRadius: 6, padding: "3px 10px", fontSize: 11, color: "#A855F7", fontFamily: "'Space Mono', monospace" }}>
//                   Featured
//                 </div>
//               )}
...
//                 {p.highlights.map((h) => (
//                   <div key={h} style={{ display: "flex", alignItems: "center", gap: 8, padding: "5px 0", fontSize: 13, color: "#94A3B8" }}>
...
//           <div style={{ fontFamily: "'Space Mono', monospace", fontSize: 12, color: "#475569", letterSpacing: 2, textTransform: "uppercase", marginBottom: 20 }}>Beyond Code</div>
//           <div style={{ display: "flex", flexWrap: "wrap", gap: 12 }}>
//             {[
//               { icon: "🏏", label: "Cricket & Strategy" },
//               { icon: "💪", label: "Fitness & Discipline" },
//               { icon: "🔌", label: "Electronics & Sensors" },
//               { icon: "🧩", label: "Problem Solving" },
//               { icon: "🤝", label: "Team Collaboration" },
//               { icon: "📡", label: "Wireless Tech" },
//             ].map((i) => (
//               <div key={i.label} style={{ display: "flex", alignItems: "center", gap: 8, background: "#0F1629", border: "1px solid #1E293B", borderRadius: 8, padding: "8px 16px", fontSize: 14, color: "#94A3B8" }}>
...
//       {/* CONTACT */}
//       <Section id="contact" style={{ borderTop: "1px solid #0F1629" }}>
...
//                 <span style={{ fontSize: 14, color: "#94A3B8", flex: 1 }}>rajpohekar21@gmail.com</span>
//                 <button onClick={copyEmail} style={{ background: "transparent", border: "1px solid #1E293B", borderRadius: 6, padding: "4px 10px", fontSize: 11, color: copiedEmail ? "#00C896" : "#475569", cursor: "pointer", fontFamily: "'Space Mono', monospace", transition: "all 0.2s" }}>
...
//       {/* FOOTER */}
//       <footer style={{ borderTop: "1px solid #0F1629", padding: "2rem 1.5rem", textAlign: "center" }}>
...
//           </span>
//           <span style={{ fontFamily: "'Space Mono', monospace", fontSize: 12, color: "#1E293B" }}>© 2024 · All Rights Reserved</span>
//         </div>
//       </footer>
//     </div>
//   );
...
// Section wrapper - fixed animation triggers
function Section({ id, children, style = {} }) {
  const ref = useRef(null);
  const [visible, setVisible] = useState(false);
  useEffect(() => {
    const observer = new IntersectionObserver(
      ([e]) => {
        if (e.isIntersecting) {
          setVisible(true);
          // Stop observing once visible to prevent animation glitches
          if (ref.current) observer.unobserve(ref.current);
        }
      },
      // Lowered threshold and added rootMargin to trigger earlier
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          access_key: "8c869c42-680e-4493-a819-8a8ef6a07b2a", // Paste your key from the email here
          name: formState.name,
          email: formState.email,
          message: formState.message,
          subject: "New Contact from Portfolio!" // Optional subject line
        }),
      });
    ...
    <div style={{ background: "#0B0F19", color: "#E2E8F0", fontFamily: "'DM Sans', 'Segoe UI', sans-serif", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <section id="hero" style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 1100, margin: "0 auto", padding: "0 1.5rem", paddingTop: 80, width: "100%" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "3rem", flexWrap: "wrap-reverse", justifyContent: "space-between" }}>
            ...
            <div style={{ flex: "1 1 500px" }}>
              ...
              <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
                <button className="btn-primary" onClick={() => scrollTo("Projects")}>View My Work →</button>
                <a
                  href="https://drive.google.com/file/d/1vC2NMlhhn94UE9_3PJtNHJ4JXwfUm8_v/view?usp=sharing"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ textDecoration: "none" }}
                >
            ...
            <div style={{ flex: "1 1 300px", display: "flex", justifyContent: "center", marginBottom: "2rem" }}>
              <img
                src="https://res.cloudinary.com/dbcwka2ey/image/upload/f_auto,q_auto/WIN_20250620_11_03_45_Pro_osbeqf"
                alt="Raj Pohekar"
                style={{
      ...
      <Section id="experience" style={{ borderTop: "1px solid #0F1629" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3rem", alignItems: "start" }}>
          ...
          <div style={{ background: "linear-gradient(135deg, #0F1629 0%, #0B0F19 100%)", border: "1px solid #A855F744", borderRadius: 16, padding: "1.75rem", position: "relative", overflow: "hidden" }}>
            ...
            <p style={{ fontSize: 13, color: "#64748B", lineHeight: 1.7, marginBottom: 16 }}>
              Optimizing the flight path of a UAV acting as a temporary 5G base station during emergencies. Utilizing Reinforcement Learning (Q-learning) so the UAV learns an optimal trajectory to maximize data rate and coverage while minimizing energy consumption.
            </p>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 6, marginBottom: 16 }}>
              {["Reinforcement Learning", "Q-Learning", "5G Networks", "Energy Efficiency"].map((t) => (
                <Tag key={t} color="#A855F7">{t}</Tag>
              ))}
            </div>
            <div style={{ padding: "10px 14px", background: "#A855F711", border: "1px solid #A855F733", borderRadius: 8, fontSize: 12, color: "#A855F7", fontFamily: "'Space Mono', monospace", textAlign: "center" }}>
